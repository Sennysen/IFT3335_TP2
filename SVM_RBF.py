...
# Evaluation
print("Accuracy of SVM RBF with count:", accuracy_score(y_test, y_pred))
...
# Evaluation
print("Accuracy of SVM RBF with TFIDF:", accuracy_score(y_test, y_pred))
print("\nClassification Report:")
print(classification_report(y_test, y_pred))
...
print("Accuracy of SVM RBF with tokenization, stopword removal, lemmatization and count:", accuracy_score(y_test, y_pred))
print("\nClassification Report:")
print(classification_report(y_test, y_pred))
...
print("Accuracy of SVM RBF with tokenization, stopword removal, lemmatization and TFIDF:", accuracy_score(y_test, y_pred))
print("\nClassification Report:")
print(classification_report(y_test, y_pred))
...
print("Accuracy of SVM RBF with tokenization, stopword removal, stem and count:", accuracy_score(y_test, y_pred))
print("\nClassification Report:")
print(classification_report(y_test, y_pred))
...
print("Accuracy of SVM RBF with tokenization, stopword removal, stem and TFIDF:", accuracy_score(y_test, y_pred))
print("\nClassification Report:")
print(classification_report(y_test, y_pred))
...
print("Accuracy of SVM RBF with tokenization, stopword removal and count:", accuracy_score(y_test, y_pred))
print("\nClassification Report:")
print(classification_report(y_test, y_pred))
...
print("Accuracy of SVM RBF with tokenization, stopword removal and TFIDF:", accuracy_score(y_test, y_pred))
print("\nClassification Report:")
print(classification_report(y_test, y_pred))